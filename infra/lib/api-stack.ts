...
export class ApiStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ApiStackProps) {
    ...
    grantRW(walletFn, [props.tables.users, props.tables.transactions, props.tables.withdrawals, props.tables.dailyDeposits, props.tables.depositRequests, props.tables.cache]);
