...
export default function HomePage() {
  ...
  return (
    <div className="text-center py-10 md:py-20 px-2">
      <AmbientConfetti />
      <img src="/logo-192.png" alt="SORTYAPP" className="w-24 h-24 md:w-32 md:h-32 mx-auto mb-6 rounded-full" />
      ...
      <div className="mt-16 max-w-md mx-auto">
        <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{t('home.community')}</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">{t('home.communityDesc')}</p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a
            href="https://t.me/+QRZm9paZ-Og2ZmFh"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 bg-[#229ED9] text-white px-5 py-2.5 rounded-lg font-medium hover:bg-[#1a8ac4] transition-colors w-full sm:w-auto"
          >
          ...
          <a
            href="https://chat.whatsapp.com/GhLfwkAYiKaDlGihbWW49f?mode=gi_t"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white px-5 py-2.5 rounded-lg font-medium hover:bg-[#1fb855] transition-colors w-full sm:w-auto"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
